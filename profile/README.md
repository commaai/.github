...
* **[comma four](https://comma.ai/shop/comma-four)**: our device to make driving chill
...
* [commaCarSegments](https://huggingface.co/datasets/commaai/commaCarSegments): sanitized segments of can and carParams for each car that openpilot supports
